...
#### Исторически сложившиеся каналы
1. Канал по-умолчанию LongFast. Обычно уже присутствует, стандартный ключ **AQ==**
1. Канал **PingPong**, ключ **MQ==**. В канале сидят боты и люди, которые могут ответить(и в ручную) о количестве хопов. Полезно для проверки связи.
1. Канал **NNCHAT**, ключ **QQ==**. Дополнительный канал к основному. Обычно тут живительная тишина :)
