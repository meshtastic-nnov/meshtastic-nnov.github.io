...
https://apps.apple.com/us/app/meshtastic/id1586432531?l=ru
...
https://f-droid.org/en/packages/com.geeksville.mesh/
...
- Удаленно, используя команды администратора. Будет рассмотрено позже, требует предварительной настройки.
...
#### Соединение с нодой
![Соединение с нодой](assets/img/01-Connection.png)
Выбрать доступный способ подключения. После удачной попытки коннекта вы увидете примерно это.

#### Секция настроек
![Секция настроек](assets/img/02-Settings-main.png)

##### LoRa
![LoRa](assets/img/03-Settings-Lora-01.png)
- регион, 
- вещательный пресет, 
- лимит "прыжков"

![LoRa](assets/img/04-Settings-Lora-02.png)
- частотный слот, 
- частота, 
...
##### Каналы
![Каналы](assets/img/05-Settings-Channels-LongFast.png)
...
##### Пользователь
![Пользователь](assets/img/09-Settings-User.png)
- Длинное имя ноды
- Короткое имя ноды
...
![Пользователь](assets/img/09-01-Settings-User-02.png)
- Зеленый замок

##### Устройство
![Устройство](assets/img/10-Settings-Device-01.png)
...
![Устройство](assets/img/11-Settings-Device-02.png)
- Отключение мерцания светодиода. Актуально для автономных нод с целью экономии энергии.
- Временная зона. 

##### Позиция
![Позиция](assets/img/12-Settings-Position-01.png)
- Интервал трансляции геопозиции.
- "Умный" режим геопозиции. Актуален для передвижных нод.

В зависимости от комфортного для вас уровня анонимности, вы можете выставить режим передачи координат GPS по сети. В среднем договорились о выставлении приблизительной координаты расположения ноды с погрешностью в один-два километра. Можно выставить режим передачи координат от встроенного GPS модуля, передачу координат со смартфона, передача фиксированных координат. Если вы используете мобильную ноду настройте таймаут выключения экрана в секундах удобный для вас, например 10 секунд.

![Позиция](assets/img/13-Settings-Position-02.png)
- Режим фиксированной позиции для стационарных нод.
- Широта, толгота, высота над уровнем моря.

##### Питание
![Питание](assets/img/14-Settings-Power.png)
- Режим экономии энергии. Применимо для автономных нод на солнечной батарее. 

##### Сеть
![Сеть](assets/img/15-Settings-Network.png)
- Включение WiFi
...
##### Bluetooth
![Bluetooth](assets/img/16-Settings-Bluetooth.png)
...
##### Разное
![Питание](assets/img/17-Settings-Other.png)
